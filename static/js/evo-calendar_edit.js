...
;(function(factory) {
    ...
    EvoCalendar.prototype.addEventList = function(event_data) {
        ...
        markup += '></div></div><div class="event-info"><p class="event-title">'+_.limitTitle(event_data.equipe)+" - "+_.limitTitle(event_data.name);
        if (event_data.badge) markup += '<span>'+event_data.badge+'</span>';
        markup += '</p>'
        if (event_data.description) markup += '<p class="event-desc">'+event_data.description+'</p>';
        markup += '<br>'; //============================================================================================================================================
        markup += '<p class="event-desc" style="text-align:right"> id: '+event_data.id+'</p>';
        markup += '</div>';
        markup += '</div>';
        eventListEl.append(markup);
